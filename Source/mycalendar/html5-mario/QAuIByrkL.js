var Mario = {
    ...
    Tile: {
        ...
        LoadBehaviors: function() {
            for (var a = [0, 20, 28, 0, 130, 130, 130, 130, 2, 2, 2, 2, 2, 0, 138, 0, 162, 146, 154, 162, 146, 146, 154, 146, 2, 0, 2, 2, 2, 0, 2, 0, 192, 192, 192, 192, 0, 0, 0, 0, 2, 2, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 0, 0, 2, 2], b = 0, b = 58; b < 128; b++)
                a[b] = 0;
            a[128] = 2;
            a[129] = 2;
            a[130] = 2;
    ...
    GenerateOverground: function(a) {
        for (var b = this.Distant ? 4 : 6, c = this.Distant ? 2 : 1, e = Math.floor(Math.random() * b) + c, d = Math.floor(Math.random() * b) + c, f = 0, g = 0, h = 0, i = 0, i = 2, f = 0; f < this.Width; f++) {
            ...
            for (g = 0; g < this.Height; g++)
                h = e < d ? e : d,
                i = e < d ? d : e,
                g < h ? this.Distant ? (i = 2,
                g < 2 && (i = g),
                a.SetBlock(f, g, 4 + i * 8)) : a.SetBlock(f, g, 5) : g === h ? (i = h === d ? 0 : 1,
                i += this.Distant ? 2 : 0,
                a.SetBlock(f, g, i)) : g === i ? (i = h === d ? 0 : 1,
                i += this.Distant ? 2 : 0,
                a.SetBlock(f, g, i + 16)) : (i = g > i ? 1 : 0,
                h === e && (i = 1 - i),
                i += this.Distant ? 2 : 0,
                a.SetBlock(f, g, i + 8))
        }
...
Mario.BackgroundRenderer.prototype.Draw = function(a, b) {
    for (var c = b.X / this.Distance, e = 0, d = 0, f = null, f = null, g = (c + this.Width) / 32 | 0, e = c / 32 | 0; e <= g; e++)
        for (d = 0; d < this.TilesY; d++)
            f = this.Level.GetBlock(e, d) & 255,
            f = this.Background[f % 8][f / 8 | 0],
            a.drawImage(Enjine.Resources.Images.background, f.X, f.Y, f.Width, f.Height, (e << 5) - c | 0, d << 5 | 0, f.Width, f.Height)
}
;
...
Mario.ImprovedNoise.prototype = {
    Shuffle: function() {
        for (var a = [], b = 0, c = 0, e = 0, b = 0; b < 256; b++)
            a[b] = b;
        for (b = 0; b < 256; b++)
            c = (Math.random() * 255 | 0) + b,
            e = a[b],
            a[b] = a[c],
            a[c] = e,
            this.P[b + 256] = this.P[b] = a[b]
    },
    PerlinNoise: function(a, b) {
        for (var c = 0, e = 0, d = 0, c = 0; c < 8; c++)
            d = 64 / (1 << c),
...
Mario.NotchSprite.prototype.Draw = function(a) {
    var b = 0
      , c = 0;
    this.Visible && (b = (this.XOld + (this.X - this.XOld) * this.Delta | 0) - this.XPicO,
...
Mario.Character.prototype.Blink = function(a) {
    ...
    this.Large ? (this.Image = this.Fire ? Enjine.Resources.Images.fireMario : Enjine.Resources.Images.mario,
    this.XPicO = 16,
    this.YPicO = 31,
    this.PicWidth = this.PicHeight = 32) : (this.Image = Enjine.Resources.Images.smallMario,
    this.XPicO = 8,
    this.YPicO = 15,
...
Mario.Character.prototype.Move = function() {
    if (this.WinTime > 0)
        ...
        this.DeathTime++,
        this.DeathTime < 11 ? this.Ya = this.Xa = 0 : this.DeathTime === 11 ? this.Ya = -15 : this.Ya += 2,
        this.X += this.Xa,
        this.Y += this.Ya;
    else if (this.PowerUpTime !== 0) {
        this.PowerUpTime > 0 ? (this.PowerUpTime--,
        this.Blink(((this.PowerUpTime / 3 | 0) & 1) === 0)) : (this.PowerUpTime++,
        ...
        if (this.OnGround)
            this.Ducking = Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Down) && this.Large ? !0 : !1;
        if (this.Xa > 2)
            this.Facing = 1;
        if (this.Xa < -2)
            this.Facing = -1;
        ...
        if (!Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Left) && !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Right) || this.Ducking || this.Ya < 0 || this.OnGround)
            this.Sliding = !1;
        Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) && this.CanShoot && this.Fire && this.World.FireballsOnScreen < 2 && (Enjine.Resources.PlaySound("fireball"),
        ...
        this.CalcPic();
        this.Sliding && (this.World.AddSprite(new Mario.Sparkle(this.World,(this.X + Math.random() * 4 - 2 | 0) + this.Facing * 8,(this.Y + Math.random() * 4 | 0) - 24,Math.random() * 2 - 1,Math.random(),0,1,5)),
        this.Ya *= 0.5);
        this.OnGround = !1;
        ...
        if (this.Carried !== null && (this.Carried.X *= this.X + this.Facing * 8,
...
Mario.Character.prototype.CalcPic = function() {
    var a = 0
      , b = 0;
    this.Large ? (a = (this.RunTime / 20 | 0) % 4,
    a === 3 && (a = 1),
    this.Carried === null && Math.abs(this.Xa) > 10 && (a += 3),
    this.Carried !== null && (a += 10),
    this.OnGround || (a = this.Carried !== null ? 12 : Math.abs(this.Xa) > 10 ? 7 : 6)) : (a = (this.RunTime / 20 | 0) % 2,
    this.Carried === null && Math.abs(this.Xa) > 10 && (a += 2),
    this.Carried !== null && (a += 8),
    this.OnGround || (a = this.Carried !== null ? 9 : Math.abs(this.Xa) > 10 ? 5 : 4));
    ...
    this.Large ? (this.Ducking && (a = 14),
    this.Height = this.Ducking ? 12 : 24) : this.Height = 12;
    this.XPic = a
}
;
Mario.Character.prototype.SubMove = function(a, b) {
    ...
    if (b < 0)
        if (this.IsBlocking(this.X + a, this.Y + b - this.Height, a, b))
            c = !0;
        else if (c || this.IsBlocking(this.X + a - this.Width, this.Y + b - this.Height, a, b))
            c = !0;
        else if (c || this.IsBlocking(this.X + a + this.Width, this.Y + b - this.Height, a, b))
            c = !0;
    if (a > 0)
...
Mario.Character.prototype.IsBlocking = function(a, b, c, e) {
    ...
    if ((Mario.Tile.Behaviors[d & 255] & Mario.Tile.PickUpable) > 0) {
        ...
        for (d = 0; d < 2; d++)
            for (f = 0; f < 2; f++)
                this.World.AddSprite(new Mario.Sparkle(this.World,a * 16 + d * 8 + (Math.random() * 8 | 0),b * 16 + f * 8 + (Math.random() * 8 | 0),0,0,0,2,5))
    }
...
Mario.Character.prototype.Stomp = function(a) {
    ...
    if (!(this.DeathTime > 0 || this.World.Paused))
        ...
        a instanceof Mario.Enemy || a instanceof Mario.BulletBill)
            ...
            Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) && a.Facing === 0 ? (this.Carried = a,
...
Mario.Character.prototype.GetFlower = function() {
    if (!(this.DeathTime > 0 && this.World.Paused))
        this.Fire ? (this.GetCoin(),
        Enjine.Resources.PlaySound("coin")) : (this.World.Paused = !0,
        this.PowerUpTime = 18,
...
Mario.Character.prototype.Kick = function(a) {
    if (!(this.DeathTime > 0 && this.World.Paused))
        Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) ? (this.Carried = a,
        a.Carried = !0) : (Enjine.Resources.PlaySound("kick"),
        this.InvulnerableTime = 1)
}
;
...
Mario.LevelRenderer.prototype.DrawStatic = function(a, b) {
    for (var c = 0, e = 0, d = 0, d = null, f = (b.X + this.Width) / 16 | 0, c = b.X / 16 | 0; c < f + 1; c++)
        for (e = 0; e < this.TilesY; e++)
            ...
            (Mario.Tile.Behaviors[d] & Mario.Tile.Animated) === 0 && (d = this.Background[d % 16][d / 16 | 0],
            a.drawImage(Enjine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, (c << 4) - b.X | 0, e << 4 | 0, d.Width, d.Height))
}
;
Mario.LevelRenderer.prototype.DrawDynamic = function(a, b) {
    for (var c = 0, e = 0, d = 0, f = 0, g = 0, d = null, c = b.X / 16 | 0; c <= (b.X + this.Width) / 16 | 0; c++)
        for (e = b.Y / 16 | 0; e <= (b.Y + this.Height) / 16 | 0; e++)
            ...
            (Mario.Tile.Behaviors[d & 255] & Mario.Tile.Animated) > 0 && (f = (this.Bounce / 3 | 0) % 4,
            (d % 16 / 4 | 0) === 0 && (d / 16 | 0) === 1 && (f = (this.Bounce / 2 + (c + e) / 8 | 0) % 20,
            f > 3 && (f = 0)),
...
Mario.LevelRenderer.prototype.DrawExit0 = function(a, b, c) {
    for (var e = 0, e = 0, d = null, e = this.Level.ExitY - 8; e < this.Level.ExitY; e++)
        ...
        a.drawImage(Enjine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, (this.Level.ExitX << 4) - b.X - 16, (e << 4) - b.Y, d.Width, d.Height);
    c && (e = this.Level.ExitY * 16 - 48 - Math.sin(this.AnimTime) * 48 - 8,
...
Mario.LevelRenderer.prototype.DrawExit1 = function(a, b) {
    for (var c = 0, e = null, c = this.Level.ExitY - 8; c < this.Level.ExitY; c++)
        ...
        a.drawImage(Enjine.Resources.Images.map, e.X, e.Y, e.Width, e.Height, (this.Level.ExitX << 4) - b.X + 16, (c << 4) - b.Y, e.Width, e.Height)
}
;
...
Mario.LevelGenerator.prototype = {
    ...
    BuildJump: function(a, b) {
        for (var c = (Math.random() * 4 | 0) + 2, e = c * 2 + ((Math.random() * 2 | 0) + 2), d = 0, f = 0, g = (Math.random() * 3 | 0) === 0, h = this.Height - 1 - (Math.random() * 4 | 0), d = b; d < b + e; d++)
            if (d < b + c || d > b + e - c - 1)
                for (f = 0; f < this.Height; f++)
                    f >= h ? a.SetBlock(d, f, 145) : g && (d < b + c ? f >= h - (d - b) + 1 && a.SetBlock(d, f, 9) : f >= h - (b + e - d) + 2 && a.SetBlock(d, f, 9));
        return e
    },
    BuildCannons: function(a, b, c) {
        ...
        for (g = b; g < b + e; g++) {
            ...
            for (h = 0; h < this.Height; h++)
                h >= d ? a.SetBlock(g, h, 145) : g === f && h >= i && (h === i ? a.SetBlock(g, h, 14) : h === i + 1 ? a.SetBlock(g, h, 30) : a.SetBlock(g, h, 46))
        }
        return e
    },
    BuildHillStraight: function(a, b, c) {
        ...
        for (this.AddEnemyLine(a, b + 1, b + e - 1, d - 1); i; )
            ...
            l[k - b] || l[k - b + j] || l[k - b - 1] || l[k - b + j + 1])
                ...
                (Math.random() * 4 | 0) === 0 && (this.Decorate(a, k - 1, k + j + 1, h),
                i = !1);
                for (f = k; f < k + j; f++)
                    for (g = h; g < d; g++)
                        m = 5,
                        ...
                        f === k + j - 1 && (m = 6),
                        g === h && (n = 8),
                        a.GetBlock(f, g) === 0 ? a.SetBlock(f, g, m + n * 16) : (a.GetBlock(f, g) === 132 && a.SetBlock(f, g, 180),
    ...
    Decorate: function(a, b, c, e) {
        if (!(e < 1)) {
            ...
            if (e - 4 > 0 && c - 1 - f - (b + 1 + d) > 2)
                for (g = b + 1 + d; g < c - 1 - f; g++)
                    g !== b + 1 && g !== c - 2 && (Math.random() * 3 | 0) === 0 ? (Math.random() * 4 | 0) === 0 ? a.SetBlock(g, e - 4, 22) : a.SetBlock(g, e - 4, 21) : (Math.random() * 4 | 0) === 0 ? (Math.random() * 4 | 0) === 0 ? a.SetBlock(g, e - 4, 18) : a.SetBlock(g, e - 4, 17) : a.SetBlock(g, e - 4, 16)
        }
    },
    FixWalls: function(a) {
            ...
            for (h = 0; h < e; h++) {
                for (i = g; i <= g + 1; i++)
                    for (j = h; j <= h + 1; j++)
                        ...
                        l > e - 1 && (l = e - 1),
                        f[i - g][j - h] = b[k][l];
                f[0][0] === f[1][0] && f[0][1] === f[1][1] ? f[0][0] === f[0][1] ? f[0][0] && a.SetBlock(g, h, 145 + d) : f[0][0] ? a.SetBlock(g, h, 161 + d) : a.SetBlock(g, h, 129 + d) : f[0][0] === f[0][1] && f[1][0] === f[1][1] ? f[0][0] ? a.SetBlock(g, h, 146 + d) : a.SetBlock(g, h, 144 + d) : f[0][0] === f[1][1] && f[0][1] === f[1][0] ? a.SetBlock(g, h, 145 + d) : f[0][0] === f[1][0] ? f[0][0] ? f[0][1] ? a.SetBlock(g, h, 163 + d) : a.SetBlock(g, h, 179 + d) : f[0][1] ? a.SetBlock(g, h, 130 + d) : a.SetBlock(g, h, 128 + d) : f[0][1] === f[1][1] ? f[0][1] ? f[0][0] ? a.SetBlock(g, h, 147 + d) : a.SetBlock(g, h, 131 + d) : f[0][0] ? a.SetBlock(g, h, 162 + d) : a.SetBlock(g, h, 160 + d) : a.SetBlock(g, h, 1 + 16 * d)
            }
    }
};
    ...
    if (this.DeadTime === 0) {
        ...
        if (a > -this.Width * 2 - 4 && a < this.Width * 2 + 4 && b > -this.Height && b < Mario.MarioCharacter.Height)
            if (this.Type !== Mario.Enemy.Spiky && Mario.MarioCharacter.Ya > 0 && b <= 0 && (!Mario.MarioCharacter.OnGround || !Mario.MarioCharacter.WasOnGround))
                if (Mario.MarioCharacter.Stomp(this),
                this.Winged)
                    this.Winged = !1,
                    this.Ya = 0;
                else {
...
Mario.Enemy.prototype.SubMove = function(a, b) {
    ...
    if (b < 0)
        if (this.IsBlocking(this.X + a, this.Y + b - this.Height, a, b))
            ...
            c = !0;
    a > 0 && (this.IsBlocking(this.X + a + this.Width, this.Y + b - this.Height, a, b) && (c = !0),
...
Mario.Enemy.prototype.Draw = function(a, b) {
    var c = 0
      , e = 0;
    if (this.Winged && (c = (this.XOld + (this.X - this.XOld) * this.Delta | 0) - this.XPicO,
    ...
    this.Type !== Mario.Enemy.RedKoopa && this.Type !== Mario.Enemy.GreenKoopa))
        ...
        this.XFlip = !this.XFlip;
    this.SubDraw(a, b);
    this.Winged && (c = (this.XOld + (this.X - this.XOld) * this.Delta | 0) - this.XPicO,
    e = (this.YOld + (this.Y - this.YOld) * this.Delta | 0) - this.YPicO,
    this.Type === Mario.Enemy.RedKoopa && this.Type === Mario.Enemy.GreenKoopa ? (a.save(),
    a.scale(this.XFlip ? -1 : 1, this.YFlip ? -1 : 1),
    a.translate(this.XFlip ? -320 : 0, this.YFlip ? -240 : 0),
    a.drawImage(this.Image, (this.WingTime / 4 | 0) % 2 * 16, 128, 16, 32, this.XFlip ? 320 - c - 24 : c - 8, this.YFlip ? 240 - e : e - 8, 16, 32)) : (a.save(),
    a.scale(this.XFlip ? -1 : 1, this.YFlip ? -1 : 1),
    a.translate(this.XFlip ? -320 : 0, this.YFlip ? -240 : 0),
    a.drawImage(this.Image, (this.WingTime / 4 | 0) % 2 * 16, 128, 16, 32, this.XFlip ? 320 - c - 24 : c - 8, this.YFlip ? 240 - e - 32 : e - 8, 16, 32)),
    a.restore())
...
Mario.CoinAnim.prototype.Move = function() {
    ...
    if (this.Life-- < 0) {
        ...
        for (a = 0; a < 2; a++)
            for (b = 0; b < 2; b++)
                this.World.AddSprite(new Mario.Sparkle(this.World,this.X + a * 8 + Math.random() * 8 | 0,this.Y + b * 8 + Math.random() * 8 | 0,0,0,0,2,5))
    }
...
Mario.BulletBill.prototype.CollideCheck = function() {
    if (!this.Dead) {
        ...
        if (a > -16 && a < 16 && b > -this.Height && b < this.World.Mario.Height)
            Mario.MarioCharacter.Y > 0 && b <= 0 && (!Mario.MarioCharacter.OnGround || !Mario.MarioCharacter.WasOnGround) ? (Mario.MarioCharacter.Stomp(this),
            this.Dead = !0,
            this.Xa = 0,
            this.Ya = 1,
            this.DeadTime = 100) : Mario.MarioCharacter.GetHurt()
    }
}
;
...
Mario.BulletBill.prototype.ShellCollideCheck = function(a) {
    ...
    var b = a.X - this.X
      , c = a.Y - this.Y;
    if (b > -16 && b < 16 && c > -this.Height && c < a.Height)
        return Enjine.Resources.PlaySound("kick"),
        this.Dead = !0,
        this.Xa = 0,
        this.Ya = 1,
        this.DeadTime = 100,
...
Mario.FlowerEnemy = function(a, b, c) {
    ...
    this.Ya = -8;
    this.Y -= 1;
    for (a = a = this.Tick = this.JumpTime = this.Layer = 0; a < 4; a++)
        this.Move()
}
;
...
Mario.FlowerEnemy.prototype.Move = function() {
    ...
    if (this.DeadTime > 0) {
        ...
        this.Tick++,
        this.Y >= this.YStart ? (this.YStart = this.Y,
        a = Math.abs(Mario.MarioCharacter.X - this.X) | 0,
        this.JumpTime++,
        this.Ya = this.JumpTime > 40 && a > 24 ? -8 : 0) : this.JumpTime = 0,
        this.Y += this.Ya,
        this.Ya *= 0.9,
        this.Ya += 0.1,
...
Mario.Shell.prototype.CollideCheck = function() {
    if (!this.Carried && !(this.Dead || this.DeadTime > 0)) {
        ...
        if (a > -16 && a < 16 && b > -this.Height && b < Mario.MarioCharacter.Height)
            Mario.MarioCharacter.Ya > 0 && b <= 0 && (!Mario.MarioCharacter.OnGround || !Mario.MarioCharacter.WasOnGround) ? (Mario.MarioCharacter.Stomp(this),
...
Mario.LoadingState.prototype.CheckForChange = function(a) {
    if (this.ImagesLoaded)
        Mario.GlobalMapState = new Mario.MapState,
        a.ChangeState(new Mario.TitleState)
}
;
...
Mario.MapState.prototype.GenerateLevel = function() {
    ...
    for (var h = Math.random() * 512, i = Math.random() * 512, j = Math.random() * 512, k = Math.random() * 512, a = 0; a < 21; a++) {
        ...
        for (b = 0; b < 16; b++)
            ...
            c -= e,
            c *= 2,
            this.Level[a][b] = c > 0 ? Mario.MapTile.Water : Mario.MapTile.Grass
    }
    f = d = 9999;
    for (j = c = j = 0; j < 100 && c < 12; j++)
        if (a = (Math.random() * (20 / 3 | 0) | 0) * 3 + 2,
        b = (Math.random() * 5 | 0) * 3 + 1,
        this.Level[a][b] === Mario.MapTile.Grass)
            a < d && (d = a,
            f = b),
    ...
    for (a = 0; a < 21; a++)
        for (b = 0; b < 16; b++)
            if (this.Level[a][b] === Mario.MapTile.Grass && (a !== this.XFarthestCap || b !== this.YFarthestCap - 1))
                if (c = g.PerlinNoise(a * 10 + h, b * 10 + i),
                c > 0)
                    this.Level[a][b] = Mario.MapTile.Decoration;
    return !0
}
;
Mario.MapState.prototype.FindConnection = function(a, b) {
    for (var c = 0, e = 0, c = 0; c < a; c++)
        for (e = 0; e < b; e++)
            if (this.Level[c][e] === Mario.MapTile.Level && this.Data[c][e] === -1)
                return this.Connect(c, e, a, b),
                !0;
    return !1
}
;
Mario.MapState.prototype.Connect = function(a, b, c, e) {
    for (var d = 1E4, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, h = j = 0; h < c; h++)
        for (i = 0; i < e; i++)
            this.Level[h][i] === Mario.MapTile.Level && this.Data[h][i] === -2 && (j = Math.abs(a - h) | 0,
            k = Math.abs(b - i) | 0,
            j = j * j + k * k,
            j < d && (f = h,
            g = i,
...
Mario.MapState.prototype.DrawRoad = function(a, b, c, e) {
    ...
    if (d) {
        for (; a > c; )
            this.Data[a][b] = 0,
            this.Level[a--][b] = Mario.MapTile.Road;
        for (; a < c; )
            this.Data[a][b] = 0,
            this.Level[a++][b] = Mario.MapTile.Road
    }
    ...
    for (var c = 0, e = 0, d = -1, f = -1, g = 0, h = 0, i = 0, c = 0; c < a; c++)
        for (e = 0; e < b; e++)
            if (this.Level[c][e] === Mario.MapTile.Level) {
                ...
                for (h = c - 1; h <= c + 1; h++)
                    for (i = e - 1; i <= e + 1; i++)
                        this.Level[h][i] === Mario.MapTile.Road && g++;
                g === 1 ? (d === -1 && (d = c,
                f = e),
                this.Data[c][e] = 0) : this.Data[c][e] = 1
            }
    this.XMario = d * 16;
    this.YMario = f * 16;
    this.Travel(d, f, -1, 0)
...
Mario.MapState.prototype.Travel = function(a, b, c, e) {
    if (!(this.Level[a][b] !== Mario.MapTile.Road && this.Level[a][b] !== Mario.MapTile.Level)) {
        ...
        if (this.Level[a][b] === Mario.MapTile.Level)
            if (this.Data[a][b] > 0)
                this.Data[a][b] = this.LevelId !== 0 && (Math.random() * 4 | 0) === 0 ? -3 : ++this.LevelId;
            else if (e > 0 && (this.Data[a][b] = -1,
            e > this.Farthest))
                this.Farthest = e,
                this.XFarthestCap = a,
                this.YFarthestCap = b;
...
Mario.MapState.prototype.IsWater = function(a, b) {
    ...
    for (c = 0; c < 2; c++)
        for (e = 0; e < 2; e++)
            if (this.Level[(a + c) / 2 | 0][(b + e) / 2 | 0] !== Mario.MapTile.Water)
                return !1;
    return !0
}
;
Mario.MapState.prototype.Update = function(a) {
    ...
    if (this.WorldNumber !== 8) {
        ...
        if (this.MoveTime > 0)
            ...
            if (this.CanEnterLevel && Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) && this.Level[b][c] === Mario.MapTile.Level && this.Data[b][c] !== -11 && this.Level[b][c] === Mario.MapTile.Level && this.Data[b][c] !== 0 && this.Data[b][c] > -10) {
                ...
                if (this.Data[b][c] > 1 && (Math.random() * 3 | 0) === 0)
                    d = Mario.LevelType.Underground;
                this.Data[b][c] < 0 ? (this.Data[b][c] === -2 ? (Mario.MarioCharacter.LevelString += "X",
                e += 2) : this.Data[b][c] === -1 ? Mario.MarioCharacter.LevelString += "?" : (Mario.MarioCharacter.LevelString += "#",
                e += 1),
                d = Mario.LevelType.Castle) : Mario.MarioCharacter.LevelString += this.Data[b][c];
                this.EnterLevel = !0;
        ...
        Mario.MarioCharacter.Large ? (this.LargeMario.X = this.XMario + this.XMarioA * a | 0,
        this.LargeMario.Y = this.YMario + (this.YMarioA * a | 0) - 22,
        this.LargeMario.Update(a)) : (this.SmallMario.X = this.XMario + this.XMarioA * a | 0,
...
Mario.MapState.prototype.CalcDistance = function(a, b, c, e) {
    for (var d = 0; ; ) {
        ...
        if (this.Level[a][b] !== Mario.MapTile.Road)
            return d;
        if (this.Level[a - e][b + c] === Mario.MapTile.Road)
            return d;
        if (this.Level[a + e][b - c] === Mario.MapTile.Road)
            return d;
        d++
    ...
    if (this.WorldNumber !== 8) {
        ...
        for (c = 0; c <= 15; c++)
            for (b = 20; b >= 0; b--)
                ...
                } else if (this.Level[b][c] === Mario.MapTile.Decoration)
                    this.DecoSprite.X = b * 16,
                    this.DecoSprite.Y = c * 16,
                    this.DecoSprite.Draw(a, this.camera);
                else if (this.Level[b][c] === Mario.MapTile.Level && this.Data[b][c] === -2)
...
Mario.MapState.prototype.LevelWon = function() {
    var a = this.XMario / 16
      , b = this.YMario / 16;
    this.Data[a][b] === -2 ? this.NextWorld() : (this.Data[a][b] = this.Data[a][b] !== -3 ? 0 : -10,
    this.RenderStatic())
}
;
...
Mario.LevelState.prototype.Update = function(a) {
    ...
    for (b = this.FireballsOnScreen = 0; b < this.Sprites.Objects.length; b++)
        ...
        d !== Mario.MarioCharacter && (c = d.X - this.Camera.X,
        e = d.Y - this.Camera.Y,
        c < -64 || c > 384 || e < -64 || e > 304 ? this.Sprites.RemoveAt(b) : d instanceof Mario.Fireball && this.FireballsOnScreen++);
    if (this.Paused)
        ...
        for (c = (this.Camera.X / 16 | 0) - 1; c <= ((this.Camera.X + this.Layer.Width) / 16 | 0) + 1; c++)
            for (e = (this.Camera.Y / 16 | 0) - 1; e <= ((this.Camera.Y + this.Layer.Height) / 16 | 0) + 1; e++) {
                ...
                if (f !== null)
                    f.LastVisibleTick !== this.Tick - 1 && (f.Sprite === null || !this.Sprites.Contains(f.Sprite)) && f.Spawn(this, c, e, d),
                    f.LastVisibleTick = this.Tick;
                if (d !== 0 && (f = this.Level.GetBlock(c, e),
...
Mario.LevelState.prototype.Draw = function(a) {
    ...
    for (b = 0; b < this.Sprites.Objects.length; b++)
        this.Sprites.Objects[b].Layer === 0 && this.Sprites.Objects[b].Draw(a, this.Camera);
    a.restore();
    ...
    a.translate(-this.Camera.X, -this.Camera.Y);
    for (b = 0; b < this.Sprites.Objects.length; b++)
        this.Sprites.Objects[b].Layer === 1 && this.Sprites.Objects[b].Draw(a, this.Camera);
    a.restore();
    ...
    this.StartTime > 0 && (b = this.StartTime + this.Delta - 2,
    ...
    if (Mario.MarioCharacter.DeathTime > 0) {
        ...
        b = b * b * 0.1;
        if (b > 900 && (Mario.MarioCharacter.Lives--,
        this.GotoMapState = !0,
...
Mario.LevelState.prototype.Bump = function(a, b, c) {
    var e = this.Level.GetBlock(a, b)
      , d = 0
      , f = 0;
    (Mario.Tile.Behaviors[e & 255] & Mario.Tile.Bumpable) > 0 && (this.BumpInto(a, b - 1),
    this.Level.SetBlock(a, b, 4),
    this.Level.SetBlockData(a, b, 4),
    (Mario.Tile.Behaviors[e & 255] & Mario.Tile.Special) > 0 ? (Enjine.Resources.PlaySound("sprout"),
    Mario.MarioCharacter.Large ? this.AddSprite(new Mario.FireFlower(this,a * 16 + 8,b * 16 + 8)) : this.AddSprite(new Mario.Mushroom(this,a * 16 + 8,b * 16 + 8))) : (Mario.MarioCharacter.GetCoin(),
    Enjine.Resources.PlaySound("coin"),
    this.AddSprite(new Mario.CoinAnim(this,a,b))));
    if ((Mario.Tile.Behaviors[e & 255] & Mario.Tile.Breakable) > 0 && (this.BumpInto(a, b - 1),
    c)) {
...
Mario.LevelState.prototype.BumpInto = function(a, b) {
    var c = this.Level.GetBlock(a, b)
      , e = 0;
    (Mario.Tile.Behaviors[c & 255] & Mario.Tile.PickUpable) > 0 && (Mario.MarioCharacter.GetCoin(),
    Enjine.Resources.PlaySound("coin"),
    this.Level.SetBlock(a, b, 0),
